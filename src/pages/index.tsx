...
// logo
import logo from '@assets/logo-doosh-black.png'
		...
		<>
			...
			{/* <main className='h-screen flex flex-col items-center justify-center'>
				<section className='h-1/3'>
					<h1 className='text-black text-2xl' >Metadoosh admin dashboard</h1>
				</section>
				<section className='bg-black h-2/3'>
					<Image src={logo} width={200} height={200} alt={'logo of metadoosh'} />
				</section>
			</main> */}
                ...
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <Link href="/login">
                      ...
                      <Image className="h-8 w-auto sm:h-10" src={logo} alt='logo of metadoosh'/>
                    </Link>
              ...
              <Popover.Panel focus className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="px-5 pt-4 flex items-center justify-between">
                    <div>
                      <Image className="h-8 w-auto" src={logo} alt="logo of metadoosh" />
                    </div>
                    <div className="-mr-2">
                      <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-black sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Metadoosh</span> <span className="block text-gray-doosh xl:inline">Admin Dashboard</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
									<Link href="/login"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-black hover:bg-gray-doosh focus:bg-gray-doosh md:py-4 md:text-lg md:px-10"
										>
										Login
									</Link>
                </div>
